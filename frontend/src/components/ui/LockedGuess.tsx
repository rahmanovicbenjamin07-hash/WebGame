...
const LockGuess: React.FC<LockGuessData> = ({  imageUrl }) => {
    return(
        <div className="2xl:w-105 lg:h-59 h-47.5 min-w-86 sm:min-w-0 w-full relative flex items-center justify-center overflow-hidden">
            <img src={imageUrl} className="object-cover w-full h-full rounded-2xl"/>
