...
export function Footer(){
    return (
        <div className="max-w-360 w-full bg-gradient lg:py-4.5 py-0 lg:px-0 px-10.5 flex items-stretch justify-center lg:rounded-t-[35px] rounded-t-4xl mx-auto lg:h-auto h-16.25">
            <div className="flex justify-between max-w-324.5 w-full items-center">
                <div>
                    <img src={FooterLogo} className="hidden lg:static"></img>
                    <img src={LogoIcon} className="static lg:hidden"></img>
                </div>
                <div>
