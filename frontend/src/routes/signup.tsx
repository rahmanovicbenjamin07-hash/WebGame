...
function SignUpPage() {
  return (
    <div className="pt-38 flex flex-row lg:max-h-screen max-h-none gap-22 overflow-hidden lg:items-stretch lg:justify-end items-center justify-center w-full lg:min-h-0 min-h-screen">
