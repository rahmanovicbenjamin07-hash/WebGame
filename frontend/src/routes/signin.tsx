...
function SingInPage() {
  return(
        <div className="flex flex-row max-h-screen lg:pt-0 pt-24 gap-22 overflow-hidden lg:items-stretch lg:justify-end items-center justify-center w-full lg:min-h-0 min-h-screen">
